...
## Project Description
This project is build using Nest.js. It uses mono-repo and microservices architecture with RabbitMQ. Nest.js is a progressive <a href="http://nodejs.org" target="_blank">Node.js</a> framework for building efficient and scalable server-side applications.
